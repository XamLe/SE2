...
public class DVDTest
{
    ...
    {
        assertFalse("Mehrere Exemplare der gleichen DVD sollten ungleich sein, equals gibt hier aber true zurück!",
                _dvd1.equals(_dvd2));
        assertTrue("Ein DVD-Exemplar sollte sich selbst gleichen, equals gibt aber false zurück!",
                _dvd1.equals(_dvd1));
    }
    ...
    @Test
    /*
     * Mietgebühr soll korrekt berechnet werden.
     */
    public void testBerechneMietgebuehr()
    {
    	Medium medium = getMedium();
    	assertEquals(new Geldbetrag(5 * 300), medium.berechneMietgebuehr(5));
    }
